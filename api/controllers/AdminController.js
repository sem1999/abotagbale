...
module.exports = {
    ...
    login_api: async function (req, res) {
        ...
        if (!req.body.pseudo || !req.body.password) {
            ...
            var data = await sails.helpers.login( ""+req.body.pseudo,  ""+req.body.password,  "admin" ).intercept('UserRoleError', 'pseudoPasswordValidationError','noAccount','internalError','DataVerificationError','UserRoleError');
